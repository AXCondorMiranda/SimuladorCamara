     ...
     <div class="container mt-5">
          <div class="row justify-content-center">
              <div class="col-md-6">
                  ...
                  <form id="form_actualizar_practica" method="POST" action="{{ route('examen.update', $test->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between">
                         ...
                         <button id="btnSubmitEditPractice" type="submit" class="btn btn-primary" style="flex-basis: 50%;">Guardar</button>
